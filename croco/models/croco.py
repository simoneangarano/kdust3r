...
class CroCoNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 adapter=False,          # whether to add an adapter layer between the encoder and the decoder
                ):
        ...
        # decoder 
        if adapter:
            self._set_decoder(1024, dec_embed_dim, dec_num_heads, dec_depth, mlp_ratio, norm_layer, norm_im2_in_dec)
        else:
