...
def get_parser():
    ...
    parser.add_argument('--arkitscenes_dir', default='/ssd1/sa58728/dust3r/data/misc/ar_raw_all/raw/')
    parser.add_argument('--precomputed_pairs', default='data/arkitscenes_pairs/')
    parser.add_argument('--output_dir', default='/ssd1/sa58728/dust3r/data/arkitscenes_processed')
    return parser
